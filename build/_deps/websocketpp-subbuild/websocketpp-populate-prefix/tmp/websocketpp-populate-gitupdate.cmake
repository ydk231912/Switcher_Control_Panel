...
execute_process(
  COMMAND "/usr/bin/git" show-ref "56123c87598f8b1dd471be83ca841ceae07f95ba"
  WORKING_DIRECTORY "/root/dev_1u_new/switcher_keyboard_demmo_cc/build/_deps/websocketpp-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "56123c87598f8b1dd471be83ca841ceae07f95ba")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("56123c87598f8b1dd471be83ca841ceae07f95ba" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/56123c87598f8b1dd471be83ca841ceae07f95ba")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/dev_1u_new/switcher_keyboard_demmo_cc/build/_deps/websocketpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/dev_1u_new/switcher_keyboard_demmo_cc/build/_deps/websocketpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
